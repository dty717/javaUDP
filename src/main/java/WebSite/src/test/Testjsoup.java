...
public class Testjsoup {
    public static void main(String[] args) throws IOException {
        //Connection  con=Jsoup.connect("https://www.google.com?q=Hello+World");
        //Connection.Response res=con.method(Connection.Method.GET).execute();
        System.out.print(google_results("Hello",12));
    }
    public static List<Map<String,String>> google_results(String keyword, int no_of_results) throws IOException
	{
