...
java -cp /usr/web/javaUDP/src/main/java/WebSite/out:"/usr/web/javaUDP/src/main/java/WebSite/out/lib/jsoup-1.8.1.jar" test.Testjsoup > /usr/web/javaUDP/src/main/java/WebSite/out/test.html
